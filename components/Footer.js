...
export default function Footer() {
  return (
    ...
    <p className="description"> Assumptions. <br> You will invest. <br>For  Pay Down Debt  vs  Invest, see  getsmarteraboutmoney.ca/calculators/pay-down-debt-or-invest-calculator/ <br>
